...
public class SystemReplayAskAppTests {
    ...
    void systemReplayAskAppTest() {
        ...
        var recordedReactorSystem =
                new ReActorSystem(ExampleUtils.getDefaultReActorSystemCfg(SystemReplayAskAppTests.class.getSimpleName(),
                        dumpingLocalDriver,
